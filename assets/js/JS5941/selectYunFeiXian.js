			...
			if(data.status!=200){alert(data.message)}
				...
				$.each(message, function(index, item) {
					str+="<tr>";
						...
						if(item.MAXINDEMNITY==""||item.MAXINDEMNITY==null||item.MAXINDEMNITY==undefined){str+="<td></td>";}else{str+="<td>"+item.MAXINDEMNITY+"</td>";}
						if(item.MAXINDEMNITYA==""||item.MAXINDEMNITYA==null||item.MAXINDEMNITYA==undefined){str+="<td></td>";}else{str+="<td>"+item.MAXINDEMNITYA+"</td>";}
						if(item.MININDEMNITYA==""||item.MININDEMNITYA==null||item.MININDEMNITYA==undefined){str+="<td></td>";}else{str+="<td>"+item.MININDEMNITYA+"</td>";}
