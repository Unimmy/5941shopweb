	 ...
	 $.ajax({
	 	...
	 	success:function(data){
			...
			$.each(message, function(index, item){
				str_td+="<tr>";
					if(item.shoponeid==""||item.shoponeid==null||item.shoponeid==undefined){str_td+="<td></td>";}else{str_td+="<td>"+item.shoponeid+"</td>";}
